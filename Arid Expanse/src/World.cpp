...
void World::printWorld(int px, int py, int ex, int ey)
{
    for (int i = 0; i < 5; i++)
    {
        for (int j = 0; j < 5; j++)
...
void World::printWorld(int px, int py)
{
    for (int i = 0; i < 5; i++)
    {
        for (int j = 0; j < 5; j++)
...
Field World::getTileType(int x, int y)
{
    return world[y][x];
}

void World::clearTile(int x, int y)
{
    world[y][x].type = Field::FieldType::EMPTY;
}

int World::getTotalRelics()
{
    return totalRelics;
}

void World::relicTaken()
{
    totalRelics--;
}

Position World::getPreviousPosition()
{
    return previousPosition;
}

void World::setPreviousPosition(Position prevPos)
{
